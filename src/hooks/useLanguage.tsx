...
const translations: Translations = {
  ...
  yourPath: { ru: "Твой путь", en: "Your Path", kk: "Сіздің жолыңыз" },
  createRoadmap: { ru: "Создай свой план", en: "Create Your Plan", kk: "Жоспарыңызды жасаңыз" },
  fillProfileInfo: { ru: "Заполни данные для персонального плана", en: "Fill in your info for a personalized plan", kk: "Жеке жоспар үшін деректеріңізді толтырыңыз" },
  ...
  grade9: { ru: "9-й класс", en: "9th grade", kk: "9-сынып" },
  grade10: { ru: "10-й класс", en: "10th grade", kk: "10-сынып" },
  grade11: { ru: "11-й класс", en: "11th grade", kk: "11-сынып" },
  grade12: { ru: "12-й класс", en: "12th grade", kk: "12-сынып" },
  ...
  goalPlaceholder: { ru: "Попасть в Лигу Плюща, получить грант...", en: "Get into Ivy League, win a scholarship...", kk: "Ivy League-ге түсу, грант алу..." },
  generatePlan: { ru: "Создать план с AI", en: "Generate AI Plan", kk: "AI жоспарын жасау" },
  generatingPlan: { ru: "Создаём план...", en: "Generating plan...", kk: "Жоспар жасалуда..." },
  ...
  competition: { ru: "Конкурс", en: "Competition", kk: "Конкурс" },
  ...
  generatingOpportunities: { ru: "Генерируем возможности...", en: "Generating opportunities...", kk: "Мүмкіндіктер жасалуда..." },
  ...
  opportunitiesFound: { ru: "возможностей", en: "opportunities", kk: "мүмкіндіктер" },
